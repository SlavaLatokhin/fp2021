  ...
  { variable_list =
    [{ var_type = String; var_key = "s5"; var_value = VString ("10a");
     ...
     { var_type = String; var_key = "s1"; var_value = VString ("a");
       is_const = false; assignment_count = 1; visibility_level = 0 };
     { var_type = Int; var_key = "v9"; var_value = VInt (216);
       is_const = false; assignment_count = 1; visibility_level = 0 };
     ...
     { var_type = Int; var_key = "b"; var_value = VInt (2); is_const = false;
       assignment_count = 1; visibility_level = 0 };
     { var_type = Int; var_key = "a"; var_value = VInt (10); is_const = false;
  ...
  { variable_list = []; current_method_type = Void;
    last_expr_result = VInt (2); runtime_signal = NoSignal;
    count_of_nested_cycles = 0; visibility_level = 1 }
