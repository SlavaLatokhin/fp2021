...
Test 2 (Arithmetic operations test)
  ...
  8
  { variable_list =
    [{ var_type = Int; var_key = "b"; var_value = (VInt 27); is_const = false;
       assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "a"; var_value = (VInt 8); is_const = false;
        assignment_count = 7; visibility_level = 0 };
      { var_type = Int; var_key = "v13"; var_value = (VInt 4);
        is_const = false; assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "v12"; var_value = (VInt 6);
        is_const = false; assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "v11"; var_value = (VInt 5);
        is_const = false; assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "v10"; var_value = (VInt 5);
        is_const = false; assignment_count = 1; visibility_level = 0 };
...
Test 3 (Boolean expression test)
  ...
  > EOF  
  { variable_list =
    [{ var_type = Int; var_key = "v11"; var_value = (VInt 1); is_const = false;
       assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "v10"; var_value = (VInt 1);
        is_const = false; assignment_count = 1; visibility_level = 0 };
      { var_type = String; var_key = "s2"; var_value = (VString "b");
        is_const = false; assignment_count = 1; visibility_level = 0 };
      { var_type = String; var_key = "s1"; var_value = (VString "a");
      ...
      { var_type = Int; var_key = "d"; var_value = (VInt 10); is_const = false;
        assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "c"; var_value = (VInt 100);
        is_const = false; assignment_count = 1; visibility_level = 0 };
...
Test 4 (For loop test)
  ...
  { variable_list =
    [{ var_type = Int; var_key = "i"; var_value = (VInt 3); is_const = false;
       assignment_count = 7; visibility_level = 1 }
      ];
...
Test 5 (While loop test)
  ...
  { variable_list =
    [{ var_type = Int; var_key = "i"; var_value = (VInt 0); is_const = false;
       assignment_count = 9; visibility_level = 0 }
      ];
    current_method_type = Void; last_expr_result = (VBool false);
    runtime_signal = NoSignal; count_of_nested_cycles = 0;
    visibility_level = 0; post_inc = []; post_dec = [] }
...
Test 9 (Break test)
  ...
  0
  1
  { variable_list = []; current_method_type = Void;
...
Test 11 (Recursion test)
  ...
  { variable_list =
    [{ var_type = Int; var_key = "res"; var_value = (VInt 120);
       is_const = false; assignment_count = 1; visibility_level = 0 };
      { var_type = Int; var_key = "x"; var_value = (VInt 5); is_const = false;
        assignment_count = 1; visibility_level = 0 }
      ];
