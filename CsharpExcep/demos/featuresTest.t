...
Test 2 (Arithmetic operations test)
  ...
  { variable_list =
    [{ var_type = Int; var_key = "b"; var_value = VInt (27); is_const = false;
     ...
     { var_type = Int; var_key = "v13"; var_value = VInt (4); is_const = false;
       assignment_count = 1; visibility_level = 0 };
     { var_type = Int; var_key = "v12"; var_value = VInt (6); is_const = false;
       assignment_count = 1; visibility_level = 0 };
     { var_type = Int; var_key = "v11"; var_value = VInt (5); is_const = false;
       assignment_count = 1; visibility_level = 0 };
     { var_type = Int; var_key = "v10"; var_value = VInt (5); is_const = false;
       assignment_count = 1; visibility_level = 0 };
